...
public interface VolumeDialogController {
    ...
    public interface Callbacks {
        ...
        // requires version 2
        // Original: void onShowCsdWarning(@AudioManager.CsdWarning int csdWarning, int durationMs);
        // Android 14+ added AudioManager.CsdWarning which is not present in our framework.jar
        void onShowCsdWarning(int csdWarning, int durationMs);

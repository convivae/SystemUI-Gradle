...
public interface QSTile {
    ...
    /**
     * Return this tile's details view model to be used to render the TileDetailsView.
     *
     * The original AOSP signature is {@code default TileDetailsViewModel getDetailsViewModel()}.
     * For the Gradle environment we return {@code Object} since the Compose-based view model
     * lives in SystemUI core (com.android.systemui.qs) and would create a circular dependency.
     */
    default Object getDetailsViewModel() { return null; }

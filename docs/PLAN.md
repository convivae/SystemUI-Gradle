...
阶段 3.5.5 ✅ (Phase A.5): CONV 标记规范（ADR 0004）+ B1 product variant CONV_DEL + B2 processor stdlib 解决
阶段 3.6 🚧 (blocker): shared `Thread.getUncaughtExceptionPreHandler` 等 framework @hide API 未解析

...
12. Next, design and validate an isolation-safe production cache/factory seam as a separate task. Only after that seam, production visitor proof, focused tests, Chief acceptance, and dual-axis review proceed to Debug build/static, Release build/R8/static, and separate Debug/Release runtime gates. Task 079 remains paused.

...
15. Task 096 is planned as the next independent no-fix stage: one fresh `:app:assembleDebug --rerun-tasks` invocation followed by APK ZIP/SHA, 4/4 hidden-reference, zero-hidden-definition, and `dexdump` old-owner residual gates. Release/R8, devices, fixes, and Task 079 remain excluded.
